...
- ✅ **公文层级映射**: 脚本会额外传入 `--lua-filter=templates/official-document.lua`，确保 `#` 是公文标题，`##` 起才是正文结构层级。
...
| `## 一、标题` | 正文第一层 | 黑体 | 三号(16pt) |
| `### （一）标题` | 正文第二层 | 楷体_GB2312 | 三号(16pt) |
| `#### 1. 标题` | 正文第三层 | 仿宋_GB2312 | 三号(16pt) |
| `##### （1）标题` | 正文第四层 | 仿宋_GB2312 | 三号(16pt) |
...
**错误：** `公文层级过滤器不存在`
**解决：** 请确保 `templates/official-document.lua` 文件存在于项目中。
