...
│   ├── official-document.lua      # Markdown 公文层级映射过滤器 🧭
...
- 📦 **内置资源固定**：图形界面始终绑定内置 `official-template.docx`、`pandoc-defaults.yaml` 与 `official-document.lua`，避免打包后路径漂移。
...
| `## 一、标题` | 正文第一层 | 黑体 | 三号 (16pt) | 对应“一、”层级 |
| `### （一）标题` | 正文第二层 | 楷体_GB2312 | 三号 (16pt) | 对应“（一）”层级 |
| `#### 1. 标题` | 正文第三层 | 仿宋_GB2312 | 三号 (16pt) | 对应“1.”层级 |
| `##### （1）标题` | 正文第四层 | 仿宋_GB2312 | 三号 (16pt) | 对应“（1）”层级 |
